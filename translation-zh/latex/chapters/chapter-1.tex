...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{7f2cd7879950afca0abfe3a2c35a1a703e4d6c8e28ee44484e2aef43386318b3.jpg}
\caption{图 1.1 三个位姿和两个路标构成的玩具同步定位与建图（SLAM）示例。图中用箭头示意机器人运动，用虚线表示方位测量。}
\label{fig:chapter-1-7f2cd7879950afca0abfe3a2c35a1a703e4d6c8e28ee44484e2aef43386318b3}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{de0dd895a761a6a8ef2799623bc1231feeeca13f4f5f7a71c2097acf985dfe2a.jpg}
\caption{图 1.2 图 1.1 示例对应的贝叶斯网络，其中将已知测量 $z_1\ldots z_4$ 明确表示为方形节点。}
\label{fig:chapter-1-de0dd895a761a6a8ef2799623bc1231feeeca13f4f5f7a71c2097acf985dfe2a}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{0d4454ba5350193460ee9f212f491ce8f8f7890456553f8baea8c7f096294afa.jpg}
\caption{图 1.3 图 1.1 示例得到的因子图。}
\label{fig:chapter-1-0d4454ba5350193460ee9f212f491ce8f8f7890456553f8baea8c7f096294afa}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{6a99785c0b3ee0e08985a7267ad8e41222afe130702e8ee950c0d95d9bc80ad6.jpg}
...
\label{fig:chapter-1-6a99785c0b3ee0e08985a7267ad8e41222afe130702e8ee950c0d95d9bc80ad6}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{2d8cd5ffea6b9e14aa6cb1113efedd6424a226fa48a229db8350f93fde3f9e64.jpg}
\caption{图 1.5 一个规模更大的模拟 SLAM 示例因子图。}
\label{fig:chapter-1-2d8cd5ffea6b9e14aa6cb1113efedd6424a226fa48a229db8350f93fde3f9e64}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{9e5631051f6c2aeb5026d609b884773bd2902fc60e87816bfa9f5ecda4ab10d4.jpg}
\caption{图 1.7 图 1.1 玩具 SLAM 示例的稀疏雅可比矩阵 $A$ 的分块结构，其中空白项为零。}
\label{fig:chapter-1-9e5631051f6c2aeb5026d609b884773bd2902fc60e87816bfa9f5ecda4ab10d4}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{4f020457cc25171d369116da03c553cf2f3bd9c2efab51f4b769b89ac0e14913.jpg}
\caption{图 1.8 玩具 SLAM 问题的信息矩阵 $\pmb\Lambda$ 及其关联的无向图 $G$。}
\label{fig:chapter-1-4f020457cc25171d369116da03c553cf2f3bd9c2efab51f4b769b89ac0e14913}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{f5fad5e1ec472a6b428b7a6fe55523c80ff02dd7cd4a0aea9f1935d0fb1fde57.jpg}
\caption{图 1.9 左侧是图 1.5 问题对应的测量雅可比矩阵 $A$；右侧从上到下依次为信息矩阵 $\pmb\Lambda=A^\top A$、其上三角 Cholesky 因子 $R$，以及采用更优变量排序（COLAMD）得到的替代因子 $R$。}
\label{fig:chapter-1-f5fad5e1ec472a6b428b7a6fe55523c80ff02dd7cd4a0aea9f1935d0fb1fde57}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{f367ec43cda5f3fdc37108cc58b8d68b91a0b1c5fd955c49cbdb6bffb688dce4.jpg}
\caption{图 1.10 玩具 SLAM 示例的变量消元：按 $\ell_1,\ell_2,p_1,p_2,p_3$ 的顺序，将图 1.3 的因子图转换为贝叶斯网络（右下）。}
\label{fig:chapter-1-f367ec43cda5f3fdc37108cc58b8d68b91a0b1c5fd955c49cbdb6bffb688dce4}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{7f7da02ffac9b2ac7ca9019d72b500da0d139492bdb2841af98e305211d9b176.jpg}
\caption{图 1.11 将变量 $\ell_1$ 消元作为一次部分稀疏分解步骤。}
\label{fig:chapter-1-7f7da02ffac9b2ac7ca9019d72b500da0d139492bdb2841af98e305211d9b176}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{e2e8d95287a0da35908e51410277a99b2c009af7c8e501191f52e42f89f6f4b6.jpg}
\caption{图 1.12 玩具示例中剩余的消元步骤，完成一次完整 QR 分解。右下角的最后一步展示了最终贝叶斯网络与稀疏 Cholesky 因子 $R$ 的等价性。}
\label{fig:chapter-1-e2e8d95287a0da35908e51410277a99b2c009af7c8e501191f52e42f89f6f4b6}
\end{figure}
